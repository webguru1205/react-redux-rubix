      ...
      <div id='body'>
        ...
        <div className="body-sidebar__container">
            ...
            <Row>
              ...
              <Col sm={12}>
                <ul className="videos-list thumb">
                  <li className="plus"><Link to="javascript:;" onClick={::this.newProject}><span className="rubix-icon icon-ikons-plus"></span></Link></li>
          ...
          <div className="body-sidebar__element">
            ...
            <p>Here are some things that you might want to get started on immediately:</p>
