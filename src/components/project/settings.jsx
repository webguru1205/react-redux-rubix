...
class ProjectSettings extends React.Component {
  ...
  render() {
    ...
    let thumbnail = null;
    if(project && project.thumbnail && project.thumbnail != "") {
      thumbnail = <img src={ project.thumbnail } />;
    }
    else {
            ...
            <div className="scroll-container">
              <div className="pr5-imp pl5-imp scroll-box">
                ...
                <Form horizontal className="form-settings">
                  ...
                  <FormGroup>
                    <Col sm={10}>
                      <Slider value={opacity} min={40} tipFormatter={null} onChange={::this.handleOpacity} />
                    </Col>
                    <Col componentClass={ControlLabel} sm={2}>{opacity}%</Col>
                  </FormGroup>
                </Form>
              </div>
