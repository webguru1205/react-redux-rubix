    ...
    render() {
        ...
        return connectDragSource(connectDropTarget(
            <tr style={{opacity}} className={className}>
                ...
                <td className="cell-title" onClick={drag ? null: editor}>{metadata.title ? metadata.title : '---- ----'}</td>
                <td className="cell-title" onClick={drag ? null: editor}>{metadata.artist? metadata.artist: '----'}</td>
