...
class Login extends React.Component {
    ...
    render() {
        const { isAuthenticating, statusText } = this.props;
                    ...
                    <Modal.Body>
                        ...
                        <Form onSubmit={::this.login}>
                            <FormGroup className="text-center" controlId="email">
                                <FormControl type='text' id="email" placeholder='Your email address' ref={(username) => this.username = username} autoFocus />
                            </FormGroup>
